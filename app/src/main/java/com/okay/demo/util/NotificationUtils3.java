...
public class NotificationUtils3 extends ContextWrapper {

    private NotificationManager manager;
    public static final String id = "IMPORTANCE_LOW";
    public static final String name = "IMPORTANCE_LOW_name_1";

    public NotificationUtils3(Context context){
        super(context);
    }
    ...
    public void sendNotification(String title, String content){
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            ...
            intent.setAction("com.okay.notification");
            intent.putExtra("select", id);
            PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(), (int) System.currentTimeMillis(), intent, PendingIntent
                    .FLAG_UPDATE_CURRENT);
