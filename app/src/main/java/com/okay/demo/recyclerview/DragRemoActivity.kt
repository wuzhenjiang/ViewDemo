...
/**
 *@author wzj
 *@date 3/28/21 4:37 PM
 * 拖动排序删除
 */
class DragRemoActivity : AppCompatActivity() {
    var ITEMS = arrayOf(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_divider_line)
        recyclerView.layoutManager = GridLayoutManager(DividerLineActivity@ this, 3)
        ...
        switchLayoutManager()
        var itemDragHelper = ItemTouchHelper(object:ItemTouchHelper.Callback(){
            ...
            override fun onMove(
                ...
                Collections.swap(mDataList, viewHolder.adapterPosition, target.adapterPosition)
                recyclerView.adapter?.notifyItemMoved(viewHolder.adapterPosition,target.adapterPosition)
                return true
            }

            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                mDataList.removeAt(viewHolder.adapterPosition)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.setting -> {
                recyclerView.layoutManager = LinearLayoutManager(DividerLineActivity@ this)
                switchLayoutManager()
            }
            R.id.setting1 -> {
                recyclerView.layoutManager = GridLayoutManager(DividerLineActivity@ this, 3)
